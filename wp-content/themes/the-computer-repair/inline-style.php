<?php
	...
	if($the_computer_repair_products_padding_top_bottom != false){
		$the_computer_repair_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$the_computer_repair_custom_css .='padding-top: '.esc_html($the_computer_repair_products_padding_top_bottom).'!important; padding-bottom: '.esc_html($the_computer_repair_products_padding_top_bottom).'!important;';
		$the_computer_repair_custom_css .='}';
	}
	...
	if($the_computer_repair_products_padding_left_right != false){
		$the_computer_repair_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$the_computer_repair_custom_css .='padding-left: '.esc_html($the_computer_repair_products_padding_left_right).'!important; padding-right: '.esc_html($the_computer_repair_products_padding_left_right).'!important;';
		$the_computer_repair_custom_css .='}';
	}
	...
	if($the_computer_repair_products_box_shadow != false){
		$the_computer_repair_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
				$the_computer_repair_custom_css .='box-shadow: '.esc_html($the_computer_repair_products_box_shadow).'px '.esc_html($the_computer_repair_products_box_shadow).'px '.esc_html($the_computer_repair_products_box_shadow).'px #ddd;';
		$the_computer_repair_custom_css .='}';
	}
	...
	if($the_computer_repair_products_border_radius != false){
		$the_computer_repair_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$the_computer_repair_custom_css .='border-radius: '.esc_html($the_computer_repair_products_border_radius).'px;';
		$the_computer_repair_custom_css .='}';
	}